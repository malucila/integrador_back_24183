...
class Catalogo:
    ...
    #----------------------------------------------------------------
    def modificar_producto(self, codigo, nueva_descripcion, nueva_cantidad, nuevo_precio, nueva_imagen, nuevo_proveedor,nuevo_gluten):
        sql = "UPDATE productos SET descripcion = %s, cantidad = %s, precio = %s, imagen_url = %s, proveedor = %s,gluten =%s WHERE codigo = %s"
        valores = (nueva_descripcion, nueva_cantidad, nuevo_precio, nueva_imagen, nuevo_proveedor, nuevo_gluten,codigo)
        self.cursor.execute(sql, valores)
        self.conn.commit()
...
def agregar_producto():
    ...
    nuevo_codigo = catalogo.agregar_producto(descripcion, cantidad, precio,gluten) # nombre_imagen, proveedor)
    if nuevo_codigo:    
...
def modificar_producto(codigo):
    ...
    if catalogo.modificar_producto(codigo, nueva_descripcion, nueva_cantidad, nuevo_precio, nombre_imagen, nuevo_proveedor,nuevo_gluten):
